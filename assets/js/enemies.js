...
class Enemy {
  ...
  const spider = new Enemy('Giant Spider', 25, 8, 12, 20, 50, 14)
  ...
  const golem = new Enemy('Golem', 50, 6, 10, 10, 15, 35)
  const golemite = new Enemy('Golemite A', 25, 3, 5, 5, 7, 15)
  const golemitea = new Enemy('Golemite A', 25, 3, 5, 5, 7, 15)
  const golemiteb = new Enemy('Golemite B', 25, 3, 5, 5, 7, 15)
